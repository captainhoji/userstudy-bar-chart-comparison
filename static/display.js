...
export function displayCharts({ data, task, correctAnswer, layout, orientation, chartType, label = false, scale = 1 }) {
  currentChartConfig = { data, task, correctAnswer, layout, orientation, chartType, label, scale };
  ...
  const chartSpec1 = drawBarChart({ values: data[0], redIndex: data[6][0], isAnswer: isCorrectAnswerFirst, label, orientation, chartType, scale, colorScheme: "blues" });
  const chartSpec2 = drawBarChart({ values: data[1], redIndex: data[6][1], isAnswer: !isCorrectAnswerFirst, label, orientation, chartType, scale, colorScheme: "blues"});
