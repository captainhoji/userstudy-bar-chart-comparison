...
export async function initializeStudy(participantId, task, orientationStr, layoutStr, chartType) {
  ...
  const response = await fetch('/initialize_task', {
    ...
    body: JSON.stringify({ participant_id: participantId, task, orientationStr, layoutStr, chartType, message: "initialize" })
  });
