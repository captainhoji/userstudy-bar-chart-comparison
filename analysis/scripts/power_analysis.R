...
steps <- c(20, 40, 60, 80, 100, 120) # which sample sizes do we want to look at?
...
multiplotPower(power_analysis_results, ppi = 300, filename = "../output/power_analysis_acc_tier000_wBlock_fullRandom_n1000.png")